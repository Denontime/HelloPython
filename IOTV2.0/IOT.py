...
LastEditTime: 2021-04-02 09:36:31
'''
import binascii
import os
import random
...
if __name__ == '__main__':
    ...
    #/**************************************  *************************************/
        ...
        if Receive_flag:
            # Up_Data.append(Dict['Values']['Up_Speed'])
            try:
            for i in range(len(Up_Data)):
                ...
                ax.plot(range(data_points), Up_Data[i:i + data_points], color='purple')
                print(range(data_points))
                print(Up_Data[i:i + data_points])
                Fig_Up.draw()
                # Fig_Mid.draw()
                # Fig_Down.draw()
            Receive_flag = False
