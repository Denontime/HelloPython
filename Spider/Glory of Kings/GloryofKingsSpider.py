...
@LastEditTime: 2020-03-31 20:44:50
'''
# 1.导入所需模块
import requests
import os
...
print('\n--------------------------------王者荣耀皮肤壁纸下载--------------------------------')
print('\n     本程序会下载当前版本王者荣耀官方公布的所有英雄的皮肤图片（包括英雄伴生皮肤），')
print('储存于电脑 C盘 Kings 文件夹下。本程序仅供个人学习娱乐，所有文件版权为腾讯公司所有，')
print('不可用于商业用途，任何非正常使用造成的后果自负，与程序制作者无关！')
print('\n版本：v1.1')
print('                                                          MPS')
...
try:
    ...
    for m in range(len(json_list)):
        ...
        for i in range(1, skin_count + 1):
            ...
            with open('C:/Kings/' + '%s' % hero_name +'/' + skin_name[i - 1] + '.jpg', 'wb') as f:
                f.write(picture)
