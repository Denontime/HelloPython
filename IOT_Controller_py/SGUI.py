...
version: 1.0
Author: Mar Ping
Date: 2021-03-17 13:59:51
LastEditors: Mar Ping
LastEditTime: 2021-03-19 15:39:35
'''
...
def main():
    ...
    layout = [[sg.Text('Enter width, height of graph')],
              [sg.Input(600, size=(6, 1), key='w'), sg.Input(300, size=(6, 1), key='h')],
              [sg.Ok(), sg.Cancel()]]
    ...
    layout = [  [sg.Text('This is a Graph')],
                [sg.Button('Quit', button_color=('white', 'black'))],
