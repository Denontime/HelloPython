...
LastEditTime: 2021-03-23 12:21:42
'''
...
def Ui():
    ...
    Frame_Right_Layout = sg.Frame("Right",
                                        [[sg.Column([
                                                        ...
                                                        [sg.Button(key='-Prior-', image_filename='./img/Prior.png', image_size=(50,50), border_width=0, button_color='#64778d'),
                                                        sg.Button(key='-Next-', image_filename='./img/Next.png', image_size=(50,50), border_width=0, button_color='#64778d')],
                                                    ],
